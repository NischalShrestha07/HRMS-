...
class JobController extends Controller
{
    ...
    public function jobView($id)
    {
        ...
        $job_view = AddJob::where('id', $id)->get();
    ...
    {
        $apply_for_jobs = ApplyForJob::where('job_title', $job_title)->get();
    ...
    {
        $cv_uploads = ApplyForJob::where('id', $id)->first();
    ...
    {
        $job_view_detail = AddJob::where('id', $id)->get();
    ...
    public function manageResumesIndex()
    {
        $department    = department::get();
        $type_job      = TypeJob::get();
        $manageResumes = AddJob::join('apply_for_jobs', 'apply_for_jobs.job_title', 'add_jobs.job_title')
